...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recruiter.city'
        db.add_column(u'startups_list_recruiter', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities_users.City'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recruiter.city'
        db.delete_column(u'startups_list_recruiter', 'city_id')
